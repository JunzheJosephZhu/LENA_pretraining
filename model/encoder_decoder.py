...
if __name__ == "__main__":
    ...
    encoder = Encoder(n_layers=n_layers, channels_interval=channels_interval)
    decoder = Decoder(n_layers=n_layers, channels_interval=channels_interval)
    input = torch.randn(1, 1, 2**14)
    print(input.shape)
    e = encoder(input)
    print(e.shape)
    o = decoder(e)
